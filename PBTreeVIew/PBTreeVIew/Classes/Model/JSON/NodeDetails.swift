...
class NodeDetails: Mappable {
    ...
    public func setNodeDetails(ssn: String, relative_ssn: String, name: String, gender: String, dateOfBirth: Double?, dateOfDeath: Double?, relation: String, relation_id: Int?, relatives: [RelationshipDetails]?) {
        self.social_security_number = ssn
        self.relative_social_security_number = relative_ssn
        self.name = name
        self.gender = gender
